...
$PHOTO_PATH		= 'HirschP2.jpg';			// File name of user's profile photo in the assets/images/profilephotos directory.
$JOB_TITLE		= 'Cybersecurity Student';	// User's job title as intended to be printed.
$EMAIL_ADDRESS	= 'HirschP2@nku.edu';		// User's e-mail address, will also be used in a mailto: link.  Can be left as null to omit.
$PHONE_NUMBER	= '(407) 734-0654';			// User's phone number, will also be used in a tel: link.  Can be left as null to omit.
$UNAME_LINKEDIN	= 'patrickhirsch';			// User's LinkedIn vanity URL, will also be used to generate a link to the profile.  Can be left as null to omit.
$UNAME_GITHUB	= $UNAME_LINKEDIN;			// User's GitHub username, will also be used to generate a link to the profile.  Can be left as null to omit.
$WEBSITE_URL	= 'nku.edu/~HirschP2';		// User's website in the format of yourwebsite.com, protocols will be added when needed.  Can be left as null to omit.
$PERSONAL_SUMMARY =		//User's personal summary, a brief paragraph on the user.  Note: Plain-text only, no formatting options are provided.
...
$WORK_EXPERIENCE =
	array(
		array(	'Title'			=> 'Outreach',
				...
				'TechUsed'		=> array('Meta Business Suite','Photoshop')
		),
		array(	'Title'			=> 'Web Editor',
				...
				'TechUsed'		=> array('Wordpress','SNO','PHP')
		),
		array(	'Title'			=> 'General Manager',
		...
		array(	'Title'			=> 'Assistant General Manager',
				'Company'		=> 'Norse Code Radio',
				'YearStart'		=> 2022,
				'YearLeave'		=> 2023,
				...
				'AchieveBullets'=> array('Maintained the organization\'s roster.','Tracked weekly meeting attendance.','Recorded and distributed weekly meeting minutes.','Maecenas tempus tellus eget.'),
				'TechUsed'		=> array('Google Sheets','Icecast','Wordpress')
		),
		array(	'Title'			=> 'Systems Administrator',
				'Company'		=> 'Norse Code Radio',
				'YearStart'		=> 2020,
				'YearLeave'		=> 2022,
...
//	Additional skills/tools can be defined in the indexed array, $SKILLS_TOOLS_OTHER, simply containing String representations of items to list.
$SKILLS_TOOLS_OTHER	= array('CSS','Javascript','PHP');
...
$EDUCATION =
	array(
		array(	'Degree'		=> 'BS in Cybersecurity',
				'Institution'	=> 'Northern Kentucky University',
				'YearStart'		=> 2019,
				'YearLeave'		=> 2024
		),
		array(	'Degree'		=> 'BS in Computer Science',
				'Institution'	=> 'Northern Kentucky University',
				'YearStart'		=> 2019,
				'YearLeave'		=> 2024
		),
		array(	'Degree'		=> 'High School Diploma',
...
$PROJECTS = 
	array(
		array(	'ImgPath'		=> 'HirschP2_Vampotter.jpg',
		...
		array(	'ImgPath'		=> 'HirschP2_PhotoPort.jpg',
...
$UNAME_LINKEDIN	= 'linkedin.com/in/'.$UNAME_LINKEDIN;
$UNAME_GITHUB	= 'github.com/'.$UNAME_GITHUB;
			...
			<header class="resume-header pt-4 pt-md-0">
				<div class="row">
					<div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
						<img class="picture" src="assets/images/profilephotos/<?= htmlspecialchars($PHOTO_PATH); ?>" alt="">
					</div><!--//col-->
					<div class="col">
						<div class="row p-4 justify-content-center justify-content-md-between">
							<div class="primary-info col-auto">
								<h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase"><?= htmlspecialchars($NAME); ?></h1>
								<div class="title mb-3"><?= htmlspecialchars($JOB_TITLE) ?></div>
								<ul class="list-unstyled">
									<?php if($EMAIL_ADDRESS!==null): ?>
										<li class="mb-2"><a class="text-link" href="mailto:<?= htmlspecialchars($EMAIL_ADDRESS); ?>"><i class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i><?= htmlspecialchars($EMAIL_ADDRESS) ?></a></li>
									<?php endif ?>
									<?php if($PHONE_NUMBER!==null): ?>
										<li><a class="text-link" href="tel:<?= preg_replace("/[^0-9]/",'',$PHONE_NUMBER); ?>"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i><?= htmlspecialchars($PHONE_NUMBER) ?></a></li>
									<?php endif ?>
								</ul>
							</div><!--//primary-info-->
							<div class="secondary-info col-auto mt-2">
								<ul class="resume-social list-unstyled">
									<?php if($UNAME_LINKEDIN!==null): ?>
										<li class="mb-3"><a class="text-link" href="https://<?= htmlspecialchars($UNAME_LINKEDIN); ?>"><span class="fa-container text-center me-2"><i class="fab fa-linkedin-in fa-fw"></i></span><?= htmlspecialchars($UNAME_LINKEDIN) ?></a></li>
									<?php endif ?>
									<?php if($UNAME_GITHUB!==null): ?>
										<li class="mb-3"><a class="text-link" href="https://<?= htmlspecialchars($UNAME_GITHUB); ?>"><span class="fa-container text-center me-2"><i class="fab fa-github-alt fa-fw"></i></span><?= htmlspecialchars($UNAME_GITHUB) ?></a></li>
									<?php endif ?>
									<?php if($WEBSITE_URL!==null): ?>
										<li><a class="text-link" href="https://<?= htmlspecialchars($WEBSITE_URL); ?>"><span class="fa-container text-center me-2"><i class="fas fa-globe"></i></span><?= htmlspecialchars($WEBSITE_URL) ?></a></li>
									<?php endif ?>
								</ul>
							</div><!--//secondary-info-->
						</div><!--//row-->
			...
			<div class="resume-body p-5">
				<section class="resume-section summary-section mb-5">
					...
					<div class="resume-section-content">
						<p class="mb-0"><?= htmlspecialchars($PERSONAL_SUMMARY) ?></p>
					</div>
							...
							<div class="resume-section-content">
								<div class="resume-skill-item">
									<ul class="list-unstyled mb-4">
										<?php foreach($SKILLS_TOOLS as $skill => $percent): ?>
											<li class="mb-2">
								...
								<div class="resume-skill-item">
									...
									<ul class="list-inline">
										<?php foreach($SKILLS_TOOLS_OTHER as $item): ?>
						...
						<section class="resume-section reference-section mb-5">
							...
							<div class="resume-section-content">
								<ul class="list-unstyled resume-awards-list">
									<?php foreach($AWARDS as $name => $description): ?>
										<li class="mb-2 ps-4 position-relative">
											<i class="resume-award-icon fas fa-trophy position-absolute" data-fa-transform="shrink-2"></i>
											<div class="resume-award-name"><?= htmlspecialchars($name) ?></div>
						...
						<section class="resume-section language-section mb-5">
							...
							<div class="resume-section-content">
								<ul class="list-unstyled resume-lang-list">
									<?php foreach($LANGUAGES as $name => $description): ?>
										<li class="mb-2"><span class="resume-lang-name font-weight-bold"><?= htmlspecialchars($name) ?></span> 
